...
const Page: React.FC<SiteMetadataProps> = ({ data: { site } }) => (
  <Layout>
    <Helmet title={`Region - ${site.siteMetadata.title}`} />
    <div className="animated fadeIn">
      <div>
        <h3 className="title font-light">Region</h3>
        <div className="font-light">
          <p>
            An der "Romantischen Straße", im Herzen des lieblichen Taubertals,
            liegt unsere schöne Ortschaft Markelsheim. Idyllisch gelegen
            zwischen ausgedehnten Weinbergen, Feldern und Wiesen, am
