...
const ImpressumPage: React.FC<SiteMetadataProps> = ({ data }) => (
  <Layout>
    <div className="animated fadeIn">
      <Helmet title={`Impressum - ${data.site.siteMetadata.title}`} />
      <h3 className="u-text-center font-light no-select">
        <span className="u u-LR">Impressum</span>
      </h3>
    ...
    <h6>Kontaktanfragen / Kontaktmöglichkeit</h6>
    <p>
